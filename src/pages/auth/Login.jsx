    ...
    <Card>
      <div className='flex'>
        ...
        <div className='w-1/2 flex items-center justify-center pr-4'>
          <img src={img} alt="App background" className="w-xl  max-w-full h-a    uto" />
        </div>
        ...
        <div className='w-1/2 pl-4 border-l border-gray-400 dark:border-gray-600'>
          <form className="max-w-sm mx-auto">
            <div className="mb-6">
              <h1 className="mb-2 text-dark text-3xl font-bold dark:text-white">Create new account</h1>
              <p className="mb-0 text-dark dark:text-white">
