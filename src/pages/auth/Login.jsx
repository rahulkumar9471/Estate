  ...
  return (
    <Card>
      ...
      <form class="max-w-sm mx-auto">
        <div class="mb-5">
        <h1 class="mb-2 text-white text-4xl font-bold h3">Create new account</h1>
        <p class="mb-0 text-white">Already a member?<a href="sign-in.html"> Log in</a></p>
          <label for="email" class="block mb-2 text-sm font-medium text-sky-900 dark:text-white">Your email</label>
        ...
        <button type="submit" class="text-white bg-blue-600 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register new account</button>
      </form>
